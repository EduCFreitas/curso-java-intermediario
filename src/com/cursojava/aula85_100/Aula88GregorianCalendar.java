...
public class Aula88GregorianCalendar {
	...
	public static void main(String[] args) {
		...
		//isLeadYear só existe em GregorianCalendar
		System.out.println(hoje.isLeapYear(2020));
		
		GregorianCalendar hoje2 = new GregorianCalendar(2017, 0, 1);
		imprimirData(hoje2);
		
		GregorianCalendar hoje3 = new GregorianCalendar(2017, 0, 1, 14, 30, 45);
		imprimirData(hoje3);
	...
	private static void imprimirData(Calendar hoje) {
		...
		System.out.printf("Hoje é: %d/%02d/%d %02d:%02d:%02d%n", dia, (mes+1), ano, hora, minutos, segundos);
	}
